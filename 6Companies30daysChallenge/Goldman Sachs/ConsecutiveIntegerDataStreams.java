public class ConsecutiveIntegerDataStreams {
    private int value, k, count;

    public ConsecutiveIntegerDataStreams(int value, int k) {
        this.value = value;
        this.k = k;
        this.count = 0;
    }
    ...
    public static void main(String[] args) {
        ConsecutiveIntegerDataStreams obj = new ConsecutiveIntegerDataStreams(4, 3);
